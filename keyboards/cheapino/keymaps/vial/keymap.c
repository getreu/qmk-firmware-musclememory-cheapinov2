 ...
 * Specifically used to clear layers (return to base) after ESC key is tapped on non-base layers.
 *
 * This matches musclememory behavior where ESC acts as an "escape to base layer" key.
 */
...
[_L2] = LAYOUT_split_3x5_3(
    ...
    KC_TRNS, LT(_L6, KC_NO), KC_TRNS,                              KC_TRNS, KC_TRNS, TD(1)
),
